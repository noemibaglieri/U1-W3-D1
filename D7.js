...
function concatStrings(string1, string2) {
  let joinedString = string1.slice(0, 2).concat(string2.slice(-2));
  return joinedString.toUpperCase();
}
console.log(concatStrings("ciao", "Noemi"));
console.log(concatStrings("Sto", "studiando!"));
